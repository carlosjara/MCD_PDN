...
# S3 sink locations
output_path = args['s3_bucket'] + "/transformation-output/"
print(output_path)
...
country_lookup_path = args['s3_bucket'] + "/transformation-input/"
print(country_lookup_path)
...
print("country lookup frame crated")
...
sourceData = glueContext.create_data_frame.from_catalog(
    database = "gluejob345-cloudformation",
